...
## Striderz Run Club
- **What:** Free social runs and walks, track nights, outdoor adventures. Community-first, optional training programs
- **Find it:** [striderz.com](https://striderz.com/)

## Flight Crew (Vancouver Running Company)
- **What:** Free group and community runs
- **Where:** Kits
- **Find it:** [vanrunco.com/pages/flight-crew](https://vanrunco.com/pages/flight-crew)

## NEOS Run Club
- **What:** Saturday morning runs at David Lam Park. "More than just a run club — a community"
- **Find it:** [runclubs.ca/vancouver/neos-run-club](https://runclubs.ca/vancouver/neos-run-club)

## Vancouver Frontrunners
- **What:** Inclusive running/walking group. No-drop policy, LGBTQ+ friendly
...
- **What:** Smaller, intimate run club with solid community. Regular runs, friendly atmosphere
- **Find it:** [Instagram](https://instagram.com/averygoodrunclub)

## Kits Social Run Club
- **What:** Social runs based in Kitsilano, started summer 2024. Up-and-coming, community-focused
- **Find it:** [Instagram](https://instagram.com/kitssocialrunclub)

## Founders Running Club (Vancouver)
- **What:** Global 5-10K runs for founders, investors, operators. 30K+ members across 40+ cities, networking while running
- **Find it:** [lu.ma/foundersrc](https://lu.ma/foundersrc)

## The Vancouver Running and Jogging Club
- **What:** Runs for all ability levels. Encouraging new runners, supportive community
- **Size:** 8,700+ members
- **Find it:** [meetup.com/vanrun](https://meetup.com/vanrun)

## Kits Runners
- **What:** Kitsilano-based running group. Community runs, marathon training
